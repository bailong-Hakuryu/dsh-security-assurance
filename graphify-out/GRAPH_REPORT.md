...
- Token cost: unavailable — the historical 15-agent semantic run did not record usage
...
- `Assessment Engine` --rationale_for--> `Machine Providers Have Explicit Assessor Identity`  [INFERRED]
  CONTEXT.md → docs/adr/0015-machine-providers-have-explicit-assessor-identity.md
- `Assurance Submission` --rationale_for--> `Security Verdicts Do Not Own Mission Approval`  [INFERRED]
  CONTEXT.md → docs/adr/0002-security-verdicts-do-not-own-mission-approval.md
- `Security Assurance Plugin Boundary` --rationale_for--> `Codex Security Is a Reference, Not a Required Runtime`  [INFERRED]
  CONTEXT.md → docs/adr/0003-codex-security-is-a-reference-not-a-required-runtime.md
- `Security Policy` --rationale_for--> `Provider Capability Describes Support but Grants No Permission`  [INFERRED]
  CONTEXT.md → docs/adr/0016-provider-capability-describes-support-but-grants-no-permission.md
...
Cohesion: 0.01
Nodes (147): AirGapAccessAuditV1, AirGappedEvaluationAssemblyV1, AirGappedFindingAdjudicationV1, AirGappedRunnerInputV1, AirGappedRunnerResultV1, BenchmarkRepetitionPlanV1, BenchmarkStratumDefinitionV1, BenchmarkStratumResultV1 (+139 more)

### Community 1 - "contracts.ts"
Cohesion: 0.02
Nodes (90): AssessmentBlockedRecoveryV1, AssessmentCoverageResolutionV1, BundleOmissionV1, EvidenceConfidence, EvidenceViewProfileIdV1, EvidenceViewPurposeV1, EvidenceViewRedactionReasonV1, ExportProfileIdV1 (+82 more)

### Community 10 - "src/index.ts"
Cohesion: 0.06
Nodes (32): DisableRepositoryRequest, GetAssuranceSubmissionRequest, GetRepositoryRequest, PublicSecurityErrorCode, RegisterRepositoryRequest, UpdateRepositoryRequest, Config, Context (+24 more)

### Community 11 - "SecurityAssuranceService"
Cohesion: 0.26
Nodes (11): InvocationOptions, SecurityInvocation, SecurityResult, SecurityAssuranceService, ReferenceValidationScenario, assessmentSelectionIsConsistent(), failure(), interruption() (+3 more)
...
Cohesion: 0.06
Nodes (36): Context, SecurityAssuranceProvider, ControlPlaneAssessmentIdentity, ControlPlaneAssessmentLookup, ControlPlaneCancellationCrashCheckpoint, ControlPlaneCancellationCrashCheckpointEvent, CrashCheckpointOwner, ControlPlaneRepositoryBindingMatcher (+28 more)

### Community 14 - "SecurityAssuranceWorkbenchController"
Cohesion: 0.21
Nodes (4): SecurityAssuranceWorkbenchController, installWorkbenchUi(), AssessmentSelection(), WorkbenchOverlay()

### Community 2 - "export-delivery.ts"
Cohesion: 0.05
Nodes (49): ExportDeliveryAttemptFailureCodeV1, ExportDestinationViewV1, ExportDownloadV1, ExportId, ExportPreviewV1, ExportProfileViewV1, ExportStatusV1, GetExportDownloadRequest (+41 more)

### Community 29 - "deterministic-kernel.ts"
Cohesion: 0.22
Nodes (19): AssessmentCoverageSnapshotV1, AssessmentProfileId, AssessmentTargetSelectorV1, NodePackageLifecycleAnalyzerContributionV1, AdmittedAnalyzerInputV1, PreparedAssessmentContractV1, contributionAsJson(), analyzerEvidenceIsEligible() (+11 more)
...
Cohesion: 0.17
Nodes (27): GitTreeEntry, StableFile, SubjectFreezeError, SubjectFreezeErrorCode, SubjectManifestEntryV1, SubjectManifestPayloadV1, SubmoduleEntry, binaryDigest() (+19 more)
...
Cohesion: 0.10
Nodes (20): FindingSummaryV1, SecurityAssessmentFindingSummaryV1, WorkbenchEvidenceDisclosureViewV1, apply(), assessmentListItem(), authorityContextId(), call(), evidenceDisclosureView() (+12 more)

### Community 36 - "persistence.ts"
Cohesion: 0.09
Nodes (27): AssessmentOperatorReasonV1, RepositoryBindingsV1, RiskDecisionAuthorizationModeV1, HostRepositoryRegistrationV1, EvidenceViewPolicies, AssessmentCancellationPersistenceInput, AssessmentListRow, AssessmentResumePersistenceInput (+19 more)
...
Cohesion: 0.07
Nodes (44): AnalyzerDescriptorV1, AnalyzerEligibilityDecisionV1, AnalyzerEligibilityReasonV1, AnalyzerFactoryV1, AnalyzerIdentityV1, AnalyzerInputV1, AnalyzerInstanceV1, AnalyzerInvocationOptions (+36 more)

### Community 44 - "canonicalJson"
Cohesion: 0.20
Nodes (8): AssessmentReceiptV1, RepositoryCommandReceiptV1, RepositorySnapshotV1, RegisteredRepositoryResolution, canonicalJson(), checkSealReadiness(), readPublishedEvidenceSet(), digest()

### Community 45 - "host-repository-provider.ts"
Cohesion: 0.20
Nodes (9): RepositoryState, Config, Context, HostRepositoryBindingV1, repositoryBindingsV1Schema, bindingIdSchema, configSchema, @deepseek-ai/cordis (+1 more)

### Community 5 - "evaluation-metrics.spec.ts"
Cohesion: 0.05
Nodes (46): AirGappedEvaluationAssemblyRequestV1, AirGappedEvaluationInputError, EvaluationMetricsInputError, PairedArmComparisonInputError, PublicSecurityScorecardInputError, PublicSecurityScorecardRequestV1, ReleaseConstitutionEvaluationRequestV1, ReleaseConstitutionInputError (+38 more)
...
Cohesion: 0.16
Nodes (12): AssessmentListItemV1, AssessmentListAuthority, AssessmentListCursorError, AssessmentListQueryModule, WatermarkPayload, AssessmentListKey, authorityDigest(), project() (+4 more)

### Community 55 - "security-catalog.ts"
Cohesion: 0.21
Nodes (12): SecurityCatalogAssessmentModeV1, SecurityCatalogProfileV1, StartPreflightProviderV1, StartPreflightV1, builtinSupports(), modeCapability(), preflight(), profile() (+4 more)

### Community 56 - "sealed-artifacts.ts"
Cohesion: 0.31
Nodes (13): SealIdentityV1, structuredDigest(), artifact(), assembleSealedArtifacts(), json(), publicationDirectory(), publishSealedArtifacts(), record() (+5 more)

### Community 57 - "WorkbenchPresentation"
Cohesion: 0.19
Nodes (4): WorkbenchPresentation, WorkbenchPresentationSnapshotV1, CLOSED, OPEN

### Community 6 - "finding-query.ts"
Cohesion: 0.06
Nodes (45): FindingDetailDimensionV1, SecuritySubmissionArtifactV1, CursorPayloadV1, FindingQueryAuthority, FindingQueryCursorError, FindingQueryModule, FindingQueryNotFoundError, FindingQueryRevisionError (+37 more)

### Community 65 - ".waitForAssessmentRevision"
Cohesion: 0.13
Nodes (12): AssessmentRevisionSignalV1, WaitForAssessmentRevisionRequest, waitUntilSealed(), repositoryFixture(), waitUntilState(), nodeRepositoryFixture(), waitUntilSealed(), waitUntilSealed() (+4 more)

### Community 7 - "workbench-remote.spec.ts"
Cohesion: 0.07
Nodes (35): SecurityCallerChannelKind, SecurityPermission, TrustedCallerChannel, TrustedInvocationIssuer, AuthenticatedWorkbenchOperatorV1, WorkbenchAuthorityContextId, WorkbenchEvidenceMetadataViewV1, resolveTrustedInvocation() (+27 more)

### Community 8 - "client/index.ts"
Cohesion: 0.06
Nodes (40): Context, LocaleNamespaceMap, OpenAssessmentSelectionRequestV1, SecurityAssuranceWorkbenchListener, WorkbenchClientFailureV1, WorkbenchExportDownloadStateV1, WorkbenchKey, WorkbenchLauncherInjected (+32 more)

### Community 89 - "evidence-view.ts"
Cohesion: 0.18
Nodes (13): EvidenceViewContentV1, EvidenceViewV1, FindingDetailViewV1, GetEvidenceViewRequest, EvidenceViewAuthority, EvidenceViewModule, EvidenceViewNotFoundError, boundedContent() (+5 more)

### Community 9 - "tools.ts"
Cohesion: 0.05
Nodes (27): AssessmentState, SecurityVerdict, SecurityAssessmentStatusV1, StubAgent, findingSummaryValue(), findingsValue(), harnessSessionInvocation(), reject() (+19 more)

### Community 90 - "candidate-validation.ts"
Cohesion: 0.24
Nodes (12): AnalyzerContributionV1, CandidateValidationInputV1, AdmittedExternalAnalyzerInputV1, VerifiedSubjectTextSliceV1, candidatePrefix(), json(), referenceControlState(), validateCandidate() (+4 more)

### Community 97 - "evidence-persistence.ts"
Cohesion: 0.18
Nodes (11): ExpectedProofSourceEvidence, ReleaseEvidenceVerificationInput, EvidencePublicationReceiptV1, OpenRiskDecisionWindowPersistenceInput, evidenceEnvelope(), publishEvidenceSet(), verifyRegularCanonicalFile(), assessmentIdSchema (+3 more)
...
Cohesion: 0.09
Nodes (31): assertAccessibleControls(), assertFocused(), assertNoForbiddenBrowserState(), callWorkbenchBridge(), configureReferenceHost(), createFixtureRepository(), dismissReferenceHostOnboarding(), executeNpm() (+23 more)

### Community 17 - "packed-smoke.mjs"
Cohesion: 0.06
Nodes (12): createFixtureRepository(), executeNpm(), artifactRoot, consumerRoot, controlPlaneRoot, execute, failedRepositoryRoot, indeterminateRepositoryRoot (+4 more)
...
Cohesion: 0.13
Nodes (15): projectBlockedRecovery(), publicAssessmentSnapshot(), assessmentCoverageSnapshotV1Schema, assessmentModeSchema, assessmentOperatorReasonV1Schema, assessmentProfileIdSchema, assessmentSealV1Schema, assessmentStateSchema (+7 more)
...
Cohesion: 0.16
Nodes (14): analyzeNodePackageInstallLifecycle(), analyzerIdentity(), hasDuplicateSecurityKey(), jsonObject(), ANALYZER_METHOD, analyzerIdentitySchema, BUILTIN_NODE_PACKAGE_LIFECYCLE_DESCRIPTOR, BUILTIN_NODE_PACKAGE_LIFECYCLE_QUALIFICATION (+6 more)

### Community 60 - "evaluateReleaseConstitutionV1"
Cohesion: 0.26
Nodes (12): aggregateReleaseCheckStatus(), assembleReleaseEvidenceManifestV1(), compareReleaseBundleReferences(), evaluateReleaseConstitutionV1(), expectedConstitutionProofStatus(), releaseCountCheckStatus(), releaseEffectivenessThresholdStatus(), releaseEvidenceManifestVerification() (+4 more)
...
Cohesion: 0.36
Nodes (7): runReferenceValidationScenario(), validationRepositoryFixture(), waitUntilAssessmentState(), riskDecisionRecordV1Schema, securityAssuranceSubmissionV1Schema, run, temporaryRoots
...
Cohesion: 0.07
Nodes (26): compilerOptions, allowImportingTsExtensions, declaration, declarationMap, esModuleInterop, exactOptionalPropertyTypes, jsx, module (+18 more)

### Community 40 - "devDependencies"
Cohesion: 0.09
Nodes (23): devDependencies, @deepseek-ai/dsh-client-test-runtime, @deepseek-ai/dsh-session, @deepseek-ai/dsh-subprocess-local, @deepseek-ai/dsh-system-prompt, react-dom, @testing-library/react, tsdown (+15 more)
...
Cohesion: 0.14
Nodes (13): compilerOptions, allowImportingTsExtensions, declaration, declarationMap, noEmit, rootDir, extends, include (+5 more)
...
Cohesion: 0.20
Nodes (10): @deepseek-ai/cordis, @deepseek-ai/dsh-client-locale, @deepseek-ai/dsh-client-ui-layout, peerDependencies, @deepseek-ai/cordis, @deepseek-ai/dsh-client-locale, @deepseek-ai/dsh-client-ui-layout, @deepseek-ai/cordis (+2 more)
...
Cohesion: 0.09
Nodes (35): Assessment Coverage, Assessment Engine, Assessment Seal, Assessment State, Assessment Subject, Assurance Submission, Policy Evaluator, Security Assessment (+27 more)

### Community 19 - "Cross-Assessment Evidence reuse is contract-verified"
Cohesion: 0.09
Nodes (35): Assurance Execution Context, Assessment Seal, Coverage Plan, Assessment Workflow, Assessment Modes, Monotonic Policy Composition, Analyzer Registry, Explicit Resume (+27 more)

### Community 20 - "Evaluation Run Bundle"
Cohesion: 0.09
Nodes (35): Benchmark Corpus, Evaluation Arm, Matched-Budget Comparison, Security Effectiveness, Product Utility, Ground Truth Leakage, Capability Conformance Test Kit, Evaluation Run Bundle (+27 more)

### Community 21 - "One Security Service exposes explicit domain operations"
Cohesion: 0.09
Nodes (35): Non-inferiority Margins, Release Gates, Support Claim, Self-Security Release Gate, Conformance Evidence, Security Scorecard, Exact Qualified Build, Independent Entry Points (+27 more)

### Community 22 - "Security Service"
Cohesion: 0.07
Nodes (35): Coverage Reconciliation, Cancellation Quiescence, Risk Decision Window, Seal Publication, Security Service, Assessment Aggregate, Current Projection, Revision Journal (+27 more)

### Community 23 - "Analyzers receive only Attempt-scoped Capability Handles"
Cohesion: 0.09
Nodes (35): Startup Recovery Reconciliation, Assessment Execution Lease, Opaque Keyset Cursor, waitForRevision, Public Security Error, Analyzer Identity, Analyzer Descriptor, Capability Vocabulary (+27 more)

### Community 24 - "Role Attempt"
Cohesion: 0.07
Nodes (35): Security Role Catalog, Role Definition, Role Admission, Prompt Compiler, Context Grant, Role Attempt, Role Tool Manifest, Follow-up Request (+27 more)

### Community 25 - "Evidence Eligibility Decision"
Cohesion: 0.07
Nodes (35): Weakness Classification, Source Anchor, Evidence Type Registry, Evidence Eligibility Decision, Validation Contract Resolution, Validation Outcome, Attack Path Graph, Evidence Link (+27 more)

### Community 26 - "Security Service"
Cohesion: 0.08
Nodes (35): Surface Parity Suite, Workbench E2E, Lifecycle Conformance, Evaluation Arm, Metrics Engine, Conformance Mutant Suite, Resource Proof, Release Evidence Manifest (+27 more)

### Community 27 - "Public DTO"
Cohesion: 0.07
Nodes (35): Public DTO, Security Result, Command Receipt, Repository Administration, Runtime Health, Transport Adapter, Invariant Entry, Conformance Module (+27 more)

### Community 28 - "Workbench is a Service Client not an authority"
Cohesion: 0.09
Nodes (35): Assessment Snapshot, Revision Wait Result, Cancellation Request Receipt, Finding Detail View, Evidence View Profile, Risk Decision, Assurance Submission, Delivery Destination (+27 more)

### Community 35 - "Fix Verification"
Cohesion: 0.08
Nodes (29): Finding Fingerprint, Validation Contract, Attack Path, Remediation Case, Canonical Assessment Bundle, Baseline Policy Profile, Strict Policy Profile, Patch Artifact (+21 more)

### Community 42 - "Security Service"
Cohesion: 0.13
Nodes (19): Security Service, Assessment Subject, Subject Snapshot, Assessment Execution Lease, Evidence Key Provider, Security Authority Resolver, Repository Registry, Security Service Is Sole Mutation Boundary (+11 more)

### Community 43 - "Obligations resolve as SATISFIED, NOT_APPLICABLE, or GAP"
Cohesion: 0.18
Nodes (19): Plan Amendment, Coverage Resolution, Coverage Obligation, Not Applicable Proof, Evaluation Trace, Evaluation Instant, Policy Evaluator, Kernel Seal Readiness Check (+11 more)

### Community 48 - "Bounded Harness Capabilities"
Cohesion: 0.14
Nodes (16): Analyzer Execution Class, Bounded Harness Capabilities, Source Slice, Hybrid Analyzer Portfolio, Advisory Snapshot, Qualified Analysis Path, Coverage Reconciliation, Analyzer Execution Class Determines Verdict Eligibility (+8 more)

### Community 49 - "Release Conformance targets a packed fresh Harness installation"
Cohesion: 0.20
Nodes (16): Release Conformance, Reference Test Host, Reference Fakes, Transition Matrix, Crash Checkpoints, Multi-process Race Suite, Canonical Golden Vectors, Release Conformance targets a packed fresh Harness installation (+8 more)

### Community 52 - "Risk Decision"
Cohesion: 0.16
Nodes (15): Assessment Snapshot, Available Actions, BLOCKED Recovery View, Evidence View, Risk Decision, Dual Authority Attestation, Security Invocation, Available Actions Are Service-Projected, Not Client-Inferred (+7 more)

### Community 58 - "Control Plane Adapter"
Cohesion: 0.21
Nodes (12): Control Plane Adapter, Security Submission, ExternalAssessmentFailureV1, Repository Binding Assertion, Control Plane Integration Is an Optional By-Value Adapter, Control Plane Cancellation Resolves Only an Existing Assessment, Cancellation Crash Checkpoint Preserves the Exact Assessment, Control Plane External Failure Uses Provider-Neutral Constructor (+4 more)

### Community 66 - "Export Request"
Cohesion: 0.47
Nodes (6): Export Request, Export Delivery Worker, Export Tombstone, Export UI Previews Profile and Destination While Service Performs Delivery, Export Delivery Recovery Is Service-Owned and Bounded, Export Expiry Uses Two-Phase Exact-Target Reaping

### Community 69 - "All Product Surfaces Share One Public Service Contract"
Cohesion: 0.50
Nodes (5): Security Assessment Kernel, Assessment Engine, Public Service Contract, Codex Security Capability Breadth Is a Reference Envelope, All Product Surfaces Share One Public Service Contract
...
- **Should `WorkbenchOverlay.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.05897435897435897 - nodes in this community are weakly interconnected._
- **Should `control-plane-provider.ts` be split into smaller, more focused modules?**
