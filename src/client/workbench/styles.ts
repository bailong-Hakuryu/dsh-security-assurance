...
@media(max-width:640px){.dsh-security-backdrop{align-items:stretch;padding:0}.dsh-security-dialog{border-radius:0;max-height:none;min-height:100%;width:100%}.dsh-security-dialog__body{padding:14px}.dsh-security-empty{padding:24px}.dsh-security-assessment__heading{flex-direction:column}.dsh-security-badges{justify-content:flex-start}.dsh-security-facts{grid-template-columns:1fr}.dsh-security-actions li{grid-template-columns:1fr}.dsh-security-metrics{grid-template-columns:1fr}}
